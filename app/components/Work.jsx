...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      viewport={{ once: true }}
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my project portfolio!</motion.p>
      ...
      className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
        {workData.map((project, index)=>(
            <a href={project.githubLink} target="_blank" rel="noopener noreferrer" key={index}>
            <motion.div 
